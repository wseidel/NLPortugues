...
def sgd(f, # É o quad que foi passado.
        x0,
        step,
        iterations,
        postprocessing=None,
    ...
    for iter in range(start_iter + 1, iterations + 1):
        ...
        # Para entendimento: 
        # f: É a função 'quad' que foi passado na chamada em sanity_check.
        # f: É a função a ser otimizada, ela deve receber um único argumento 
        #         e retornar dois outputs, a loss e o gradiente em relação ao argumento
        # 
        (loss, gradiente) = f(x) # f = quad( ponto_inicial ) --> loss, gradiente
...
def sanity_check():
    ...
    # A função a ser otimizada, ela deve receber um único argumento 
    #     e retornar dois outputs, a loss e o gradiente em relação ao argumento
    quad = lambda x: (np.sum(x**2), x * 2) # Recebe x --> um np.array?, devolve uma tupla : loss e o gradiente. :)
